...
\begin{abstract}
	We present GoGP, a library for probabilistic programming around
	Gaussian processes. Kernels, beliefs about hyperparameters
	and about observation inputs and outputs are
	programmatically expressed using the same differentiable
	probabilistic programming framework. One one hand, a basic
	...
	popular for server-side programming, our library is well
	suited for integration into data processing/machine learning
	pipelines.  We demonstrate different uses of the library on

...
should provide a library of distributions for defining and
conditional random variables. To use a distribution in a
...
func (_ expon) Logps(lambda float64, y ...float64)
	...
	\end{lstlisting}
	\caption{Exponential distribution in Infergo.}

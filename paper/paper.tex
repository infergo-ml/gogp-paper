...
\end{lstlisting}
	...
	\label{fig:mammo}
\end{figure}
  Consider, for example, the probabilistic program in
  Figure~\ref{fig:mammo}. The program models dependency between
...
distribution given a set of data samples. The two parameters of
a Normal distribution are the mean $\mu$ and the standard
deviation $\sigma$. The solution can of course be obtained
analytically, but the organization of implementation and
inference possesses all of the elements of probabilistic
programming for larger, more complicated problems, for which a
closed form solution does not exist or difficult to derive.
